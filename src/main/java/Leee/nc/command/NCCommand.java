    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        if (!(sender instanceof Player)) {
            ...
            if (cmd.getName().equalsIgnoreCase("nc") && args.length != 0) {
                ...
                player.spigot().sendMessage(new TextComponent(ChatColor.GOLD + "(( Types ))"));
                player.spigot().sendMessage(new ComponentBuilder("(( ").color(ChatColor.GOLD).append("underline").color(ChatColor.RESET).underlined(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc underline-")).append("   ").color(ChatColor.RESET).underlined(false).append("underline-bold").underlined(true).bold(true).color(ChatColor.BOLD).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc underline-bold-")).append(" ))").underlined(false).bold(false).color(ChatColor.RESET).color(ChatColor.GOLD).create());
                player.spigot().sendMessage(new ComponentBuilder("(( ").color(ChatColor.GOLD).append("strike").color(ChatColor.RESET).strikethrough(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc strike-")).append("   ").strikethrough(false).color(ChatColor.RESET).append("strike-bold").strikethrough(true).bold(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc strike-bold-")).append(" ))").strikethrough(false).bold(false).color(ChatColor.RESET).color(ChatColor.GOLD).create());
                player.spigot().sendMessage(new ComponentBuilder("(( ").color(ChatColor.GOLD).append("bold").color(ChatColor.RESET).bold(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc bold-")).append("   ").bold(false).color(ChatColor.RESET).append("italic").italic(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc italic-")).append("   ").italic(false).color(ChatColor.RESET).append("italic-bold").italic(true).bold(true).event(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/nc italic-bold-")).append(" ))").italic(false).bold(false).color(ChatColor.RESET).color(ChatColor.GOLD).create());
                player.spigot().sendMessage(new TextComponent(ChatColor.GOLD+ "(( Colours ))"));
