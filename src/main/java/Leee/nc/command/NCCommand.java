    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        if (!(sender instanceof Player)) {
            ...
            if (cmd.getName().equalsIgnoreCase("nc") && args.length != 0) {
                ...
                player.spigot().sendMessage(new TextComponent(ChatColor.GOLD + "Commands:"));
                player.spigot().sendMessage(new TextComponent(ChatColor.GOLD + "/nc <color> <type-color>"));
                ...
                player.spigot().sendMessage(new TextComponent(ChatColor.GOLD+ "Colors"));
